...
import 'package:webview_quill/quill_edit2.dart';

import 'quill_edit.dart';
...
class _WebViewExampleState extends State<_WebViewExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('webview_quill'),
        actions: <Widget>[
          _SampleMenu(_controller.future),
          IconButton(
            icon: const Icon(Icons.search),
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => Editor2()));
            },
          ),
        ],
      ),
